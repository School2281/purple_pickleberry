...
# Fractal Generator Deployment Script - For Raspberry Pi
...
SOURCE_DIR="/home/pi/purple_pickleberry"        # <-- Changed from kali to pi

# Where files will be deployed (destination)
APP_DIR="/home/pi/fractal"                       # <-- Changed from /var/www/html/fractal
